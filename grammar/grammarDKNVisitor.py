...
class grammarDKNVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by grammarDKNParser#AssignExpr.
    def visitAssignExpr(self, ctx:grammarDKNParser.AssignExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by grammarDKNParser#Comparacion.
    def visitComparacion(self, ctx:grammarDKNParser.ComparacionContext):
        return self.visitChildren(ctx)
